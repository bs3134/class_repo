...
after_data=distinct(real_data,line,station_name,route,bus_number) 
after_data
```

    ## # A tibble: 5,117 x 4
    ##    line     station_name             route  bus_number
    ##    <chr>    <chr>                    <chr>  <chr>     
    ##  1 4 Avenue 25th St                  route1 R         
    ##  2 4 Avenue 36th St                  route1 N         
    ##  3 4 Avenue 45th St                  route1 R         
    ##  4 4 Avenue 53rd St                  route1 R         
    ##  5 4 Avenue 59th St                  route1 N         
    ##  6 4 Avenue 77th St                  route1 R         
    ##  7 4 Avenue 86th St                  route1 R         
    ##  8 4 Avenue 95th St                  route1 R         
    ##  9 4 Avenue 9th St                   route1 F         
    ## 10 4 Avenue Atlantic Av-Barclays Ctr route1 B         
